...
public class MessageWriter {
    ...
    private void writeMessage(Message message) {
        ...
        System.out.println("PART SIZE: " + (byte) (strMessage.getBytes().length << 24));
        System.out.println("PART SIZE: " + (byte) (strMessage.getBytes().length << 16));
        System.out.println("PART SIZE: " + (byte) (strMessage.getBytes().length << 8));
        System.out.println("PART SIZE: " + (byte) (strMessage.getBytes().length));
        try {
